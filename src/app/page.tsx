...
const PopularTopicsSection = () => {
    const topics = [
        { name: "Intro to Programming", slug: 'intro-to-programming', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg> },
        { name: "Discrete Mathematics", slug: 'discrete-mathematics', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path></svg> },
        { name: "Data Structures", slug: 'data-structures', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 16v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2M14 2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"></path><path d="M20 6h-2M20 10h-2M20 14h-2"></path></svg> },
        { name: "Algorithms", slug: 'algorithms', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20V16"/></svg> },
        { name: "Object-Oriented Programming", slug: 'object-oriented-programming', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l-10 5 10 5 10-5L12 2zM3.5 8.5v7L12 19l8.5-3.5v-7L12 5 3.5 8.5zM22 12l-10 5-10-5"></path></svg> },
        { name: "Operating Systems", slug: 'operating-systems', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="18" rx="2" ry="2"></rect><line x1="2" y1="9" x2="22" y2="9"></line><line x1="6" y1="14" x2="6" y2="14"></line><line x1="10" y1="14" x2="10" y2="14"></line></svg> },
        { name: "Computer Networks", slug: 'computer-networks', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="14" width="18" height="6" rx="2"></rect><path d="M12 14v-4"></path><path d="M12 6V4"></path><path d="M8 6h8"></path><path d="M5 14v-2a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v2"></path></svg> },
        { name: "Database Systems", slug: 'database-systems', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path></svg> },
        { name: "Software Engineering", slug: 'software-engineering', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2.5a2.5 2.5 0 0 1 5 0V5a2.5 2.5 0 0 1-5 0V2.5zM4.5 16.5a2.5 2.5 0 0 0 5 0V14a2.5 2.5 0 0 0-5 0v2.5z"></path><path d="M7 14v-1.5a2.5 2.5 0 0 1 5 0V14"></path><path d="M17 5v1.5a2.5 2.5 0 0 0 5 0V5"></path><path d="M19.5 16.5a2.5 2.5 0 0 1-5 0V14a2.5 2.5 0 0 1 5 0v2.5z"></path><path d="M7 9.5a2.5 2.5 0 0 0 5 0V7a2.5 2.5 0 0 0-5 0v2.5z"></path><path d="M12 16.5V9.5"></path></svg> },
        { name: "Web Development", slug: 'web-development', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 12.5 8 15l2 2.5M14 12.5 16 15l-2 2.5"></path><path d="m3 2 9 9 9-9"></path><path d="m3 22 9-9 9 9"></path></svg> },
        { name: "Cybersecurity", slug: 'cybersecurity', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg> },
        { name: "Compiler Design", slug: 'compiler-design', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19l-7-7 7-7 7 7-7 7z"></path><path d="M12 5v14"></path><path d="M5 12h14"></path></svg> },
        { name: "Machine Learning", slug: 'machine-learning', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v-2a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v2"/></svg> },
        { name: "Artificial Intelligence", slug: 'artificial-intelligence', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 19h-11a1 1 0 0 1-1-1v-12a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v12a1 1 0 0 1-1-1zM8 12h8m-4-4v8"></path></svg> },
        { name: "Blockchain", slug: 'blockchain', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 9.5a8.5 8.5 0 1 1-11.2-7.5"></path><path d="M9 10a5.5 5.5 0 1 1 7.8 0"></path><path d="M12 12a3 3 0 1 1 3-3"></path></svg> },
    ];
    return (
        <section className="w-full py-16 md:py-24 relative z-10">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
                    {topics.map((topic) => (
                        <Link key={topic.slug} href={`/study-materials/${topic.slug}`} className="block group">
                            <Card className="h-full flex flex-col items-center justify-center p-6 bg-gradient-card border-border/50 group-hover:border-primary/50 transition-all duration-300 transform group-hover:-translate-y-2">
